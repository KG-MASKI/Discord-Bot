...
module.exports = {
  ...
  run: async (client, interaction) => {
    const embed = new MessageEmbed()
      ...
      .addField(`🔗 Liens:`,`- [Support](https://discord.gg/R2RPp3JEpd)\n- [Inviter le bot](https://discord.com/api/oauth2/authorize?client_id=1043321106712506368&permissions=8&scope=bot%20applications.commands)`,true)
      .setTimestamp()
      .setFooter({
